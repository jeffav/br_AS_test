...
UNITTEST_CALLER_COMPLETE_EXPLICIT(test_SetTestCases_SetSetup_SetTeardown, "test_SetTestCases_SetSetup_SetTeardown", 0, 0, fixtures, setupSet, teardownSet, cyclicSetCaller);
